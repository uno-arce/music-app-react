...
export default function Register() {
	const { 
		registerInputs, register, toggleShowPassword, isFormDisabled, isRegisterButtonDisabled,
		isUsernameLengthCorrect, isUsernameCharactersCorrect, isEmailFormatCorrect,
		isEmailAvailable, isPasswordCharactersCorrect, isPasswordTextCaseCorrect, 
		isPasswordLengthCorrect, isPasswordVisible
	} = useAuth()
