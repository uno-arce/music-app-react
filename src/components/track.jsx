...
export default function Track() {
	const { trackRef, trackPreviewDetails, isTrackPlaying, isTrackMuted, togglePlayPause, toggleVolumeOnOff, handleReplay, handleVolumeChange, handleTrackEnd } = useTrack()
